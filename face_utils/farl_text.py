...
class Get_embeds(nn.Module):
    def __init__(self):
        ...
        farl_state=torch.load('weights/FaRL-Base-Patch16-LAIONFace20M-ep64.pth') # you can download from https://github.com/FacePerceiver/FaRL#pre-trained-backbones
    ...
    def forward_text(self,text_in):
        ...
        with torch.no_grad():
            enc_text= self.model.encode_text(text)
        return enc_text