...
class GaussianDiffusion:
    ...
    def p_sample(
        ...
        return {"sample": sample, "mean":out["mean"] ,"log_variance":out["log_variance"] ,"nonzero_mask": nonzero_mask, "pred_xstart": out["pred_xstart"]}
    ...
    def ddim_sample(
        ...
        sample = mean_pred
        return {"sample": sample, "mean": mean_pred, "pred_xstart": out["pred_xstart"]}
    ...
    def ddim_sample_loop_progressive(
        ...
        if noise is not None:
            ...
            img = noise #th.randn(*shape, device=device)
        indices = list(range(self.num_timesteps))[::-1]
